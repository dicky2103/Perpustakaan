                            ...
                            <div class="panel-body" id="noti-box">
                                ...
                                ?>
                                    <div class="alert alert-success">
                                        ...
                                        <strong><?php echo $data3['fullname']; ?></strong>, Telah ditambahkan menjadi admin Perpus Santuy yang baru.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-info">
                                        ...
                                        <strong><?php echo $data4['judul']; ?></strong>, Buku bacaan baru yang ada di Perpus Santuy.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-warning">
                                        ...
                                        <strong><?php echo $data5['nama']; ?> </strong> Pengunjung baru di Perpus Santuy.
                                    </div>
                                <?php } ?>
                            </div>
                        </section>
