...
<head>
    <meta charset="UTF-8">
    <title>Perpus Santuy || Membaca menjadi lebih mudah dan Jangan terlalu membebani!</title>
    ...
    <meta name="perpussantuy" content="perpussantuy" />
    <!-- bootstrap 3.0.2 -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Perpus Santuy, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
                        </div>
                    </div>
                                ...
                                <div class="twt-area">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk perpussantuy" cols="25"></textarea>
                                                <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Perpus Santuy</h4>
                </div>
                <div class="modal-body">
                    <p> Perpus Santuy adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpus Santuy memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari Perpus Santuy dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpus Santuy bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="sisteminformasi494@gmail.com">perpussantuy@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.perpussantuy.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
